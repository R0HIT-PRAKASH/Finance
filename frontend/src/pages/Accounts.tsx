...
export default function Accounts() {
  ...
  async function handleCreate() {
    ...
    setShowModal(false);
    setForm({ name: "", type: "chequing", institution: "", registered_type: "none", currency: "CAD" });
  }
            ...
            <tbody>
              {accounts.map((account) => (
                <tr key={account.id}>
                  ...
                  <td><span className="badge">{typeLabel[account.type]}</span></td>
                  <td>
                    {account.registered_type !== "none" ? (
                      <span className="badge accent">{account.registered_type}</span>
                    ) : (
        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="form-group">
              ...
              <input className="form-input" placeholder="e.g. BMO Chequing" value={form.name}
                onChange={(e) => setForm({ ...form, name: e.target.value })} />
            </div>

            <div className="form-group">
              <label className="form-label">Institution</label>
              <input className="form-input" placeholder="e.g. BMO, Amex, Canadalife" value={form.institution}
            ...
            <div className="form-group">
              ...
              <select className="form-select" value={form.registered_type}
                onChange={(e) => setForm({ ...form, registered_type: e.target.value })}>
